  ...
  return (
    <section className="relative overflow-hidden border-y border-osso/10 bg-carvao py-24 md:py-36">
      <div className="container-page relative">
        ...
        <h2 className="mt-8 max-w-4xl font-serif text-3xl font-light leading-[1.18] tracking-tight text-osso md:text-5xl md:leading-[1.16]">
          <SplitWords text="Fogo de verdade. Carne pesada na hora," />{' '}
          <span className="texto-fogo">
            <SplitWords text="selada na brasa até crostar." delay={0.1} />
          </span>{' '}
          <span className="text-osso/55">
            <SplitWords text="Sem congelado, sem atalho, sem pressa." delay={0.2} />
          </span>
        </h2>
